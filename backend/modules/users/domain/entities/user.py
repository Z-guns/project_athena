...
from backend.modules.users.domain.exceptions import InvalidDisplayNameError, UserDomainError
...
class User:
    ...
    @classmethod
    def create(cls, email: Email, display_name: str, password_hash: PasswordHash) -> Self:
        now = _utc_now()
        return cls(
            id=uuid4(),
            email=email,
